...
// Sound Effects
#define SFX_BANTER TriggerNote(PCM_CHANNEL,PATCH_BANTER,23,0xff)
#define SFX_BRICK_EXPLODE TriggerNote(PCM_CHANNEL,PATCH_BRICK_EXPLODE,23,0xff)
...
#define SFX_TANK_EXPLODE TriggerNote(PCM_CHANNEL,PATCH_TANK_EXPLODE,23,0xff)
